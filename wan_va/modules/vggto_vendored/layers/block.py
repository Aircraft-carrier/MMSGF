    ...
    def forward(
        ...
        *,
        ...
        if (
            ...
            or chunk_causal_spec is not None
            or attention_backend != "dense"
            or row_valid_mask is not None
        ):
            if not isinstance(x_or_x_list, Tensor):
                raise TypeError("masked attention requires a single tensor input")
